--PROJECT
insert into Project("id", title, description, deleteddate, ref, state)
values (1, 'Prosjekt1', 'Beskrivelse1', null, 'ccc4db69-edb2-431f-855a-4368e2bcddd1', 'ACTIVE');
insert into Project("id", title, description, deleteddate, ref, state)
values (2, 'Prosjekt2', 'Beskrivelse2', null, 'aaa4db69-edb2-431f-855a-4368e2bcddd1', 'ACTIVE');
insert into Project("id", title, description, deleteddate, ref, state)
values (3, 'Prosjekt3', 'Beskrivelse3', null, 'bbb4db69-edb2-431f-855a-4368e2bcddd1', 'ACTIVE');
insert into Project("id", title, description, deleteddate, ref, state)
values (22, 'ScriptProsjekt4', 'Beskrivelse3', '2021-09-29 21:17:30.23195', 'prosjekt4-edb2-431f-855a-4368e2bcddd1',
        'DELETED');
insert into Project("id", title, description, deleteddate, ref, state)
values (24, 'ScriptProsjekt5', 'Beskrivelse3', null, 'prosjekt5-edb2-431f-855a-4368e2bcddd1', 'ACTIVE');
insert into Project("id", title, description, deleteddate, ref, state)
values (26, 'ScriptProsjekt6', 'Beskrivelse3', null, 'prosjekt6-edb2-431f-855a-4368e2bcddd1', 'ACTIVE');
