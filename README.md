...
Spin up a postgres database docker container with the following script and add relevant settings to application.properties file
...
You can then execute your native executable with: `./target/kravbank-backend-1.0.0-SNAPSHOT-runner`
